...
public class EagerLazyDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// get courses of the instructor before session close (works fine)
			//System.out.println("Courses : " + instructor.getCourse());

			// close the session because of raising the exception for lazy loading scenario
			session.close();

			// get courses of the instructor after closing the session (this will raise an exception )
			System.out.println("Courses : " + instructor.getCourse());
