...
public class DeleteDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor instructor = session.get(Instructor.class, 1); // 1 is the primary key of instructor
			System.out.println("Found instructor : " + instructor);

			if (instructor != null) {
				System.out.println("Deleting instructor : " + instructor);

				// Note: this will also delete the details of instructor due to CascadeType ALL
